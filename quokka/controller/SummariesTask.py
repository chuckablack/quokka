...
from quokka.models.apis import get_all_hosts, get_host_ts_data_for_hour, get_all_services, get_service_ts_data_for_hour
...
class SummariesTask:
    ...
    def get_host_summaries(self):
        ...
        for host in hosts:
            ...
            if num_response_time_records > 0:
                host_hourly_summary["response_time"] = host_hourly_summary["response_time"] / num_response_time_records
            if num_availability_records > 0:
                host_hourly_summary["availability"] = host_hourly_summary["availability"] / num_response_time_records
    ...
    def get_service_summaries(self):
        ...
        for service in services:
            ...
            if num_response_time_records > 0:
                service_hourly_summary["response_time"] = service_hourly_summary["response_time"] / num_response_time_records
            if num_availability_records > 0:
                service_hourly_summary["availability"] = service_hourly_summary["availability"] / num_availability_records
    ...
    def start(self, interval):
        ...
        while True and not self.terminate:
            ...
            self.get_device_summaries()
            self.get_host_summaries()
            self.get_service_summaries()
